...
if (isset($_POST['kirim'])){
	...
	if($rowEmail){
		...
		$insert = mysqli_query($conn, "INSERT INTO contact (nama, email, subjek, pesan) VALUES ('$nama', '$email', '$subjek', '$pesan')");
		if ($insert) {
			header("location: index.php?id=#contact-section");
			die;
...
//Pulling Resume Database 
$dataResume = mysqli_query($conn, "SELECT * FROM resume");
$rowResume = mysqli_fetch_all($dataResume, MYSQLI_ASSOC);
// var_dump($rowResume);

//Pulling Skill Database
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center"><img src="assets/uploads/<?=$rowAbout['photo'] ?>" alt="" style="width: 100px;"></div> 
	    			</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span><?= $rowAbout['nama']  ?></span></li>
		            	<li class="d-flex"><span>Role:</span> <span><?= $rowAbout['jabatan']?></span></li>
		            	<li class="d-flex"><span>Description:</span> <span><?= $rowAbout['deskripsi']?></span></li>
		            </ul>
		          </div>
		        </div>
    ...
    <section class="ftco-section ftco-no-pb" id="resume-section">
    	<div class="container">
          ...
          <div class="col-md-10 heading-section text-center ftco-animate">
    		...
    		<div class="row">
						<?php 
						foreach($rowResume as $resume) {
							?>
    			<div class="col-md-6">
    				<div class="resume-wrap ftco-animate">
    					<span class="date"><?php echo $resume['tahun_awal'] . " - " . $resume['tahun_akhir'] ?></span>
    					<h2><?php echo $resume['skill']?></h2>
    					<span class="position"><?php echo $resume['instansi']?></span>
    					<p class="mt-4"><?php echo $resume['deskripsi']?></p>
    				</div>
    			</div>
					<?php
					}
				...
				<?php 
					...
					<div class="col-md-6 animate-box">
						<div class="progress-wrap ftco-animate">
							<h3><?php echo $skill['nama_skill'] ?></h3>
							<div class="progress">
							 	<div class="progress-bar color-1" role="progressbar" aria-valuenow="<?= $skill['persentase']?>"
							  	aria-valuemin="0" aria-valuemax="100" style="width:<?= $skill['persentase']?>%">
