...
if (isset($_GET['delete'])) {
  ...
  $queryProject = mysqli_query($conn, "SELECT * FROM project WHERE id = $idDel");
  $rowproject = mysqli_fetch_assoc($queryProject);
  unlink('../assets/uploads/' . $rowproject['foto']);

  $del = mysqli_query($conn, "DELETE FROM project WHERE id = $idDel");
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <!-- Button Delete -->
                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Hapus ?')" href="project.php?delete=<?php echo $row['id'] ?>">Delete</a>
                      </td>
                    </tr>
                  </tbody>
                  <?php
