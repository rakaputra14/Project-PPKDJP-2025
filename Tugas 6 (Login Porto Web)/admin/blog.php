...
if (isset($_GET['delete'])) {
  ...
  $queryBlog = mysqli_query($conn, "SELECT * FROM blog WHERE id = $idDel");
  $rowBlog = mysqli_fetch_assoc($queryBlog);
  unlink('../assets/uploads/' . $rowBlog['foto']);

  $del = mysqli_query($conn, "DELETE FROM blog WHERE id = $idDel");
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php
                          switch ($row['status']) {
                            case 1 : $label = "<span class='badge bg-primary'>Publish</span>";
                            break;
                            
                            default : $label = "<span class='badge bg-warning'>Draft</span>";
                            break;
                          }
                          echo $label;
                        ?></td>
                      <td>
                        ...
                        <!-- Button Delete -->
                        <a class="btn btn-danger btn-sm" onclick="return confirm('Yakin Ingin Hapus ?')" href="blog.php?delete=<?php echo $row['id'] ?>">Delete</a>
                      </td>
                    </tr>
                  </tbody>
                  <?php
