          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="table table-responsive">
                <a class="btn btn-primary mb-2" href="add_edit_service.php">CREATE</a>
                <table class="table table-bordered text-center">
                  ...
                  <tr>
                    ...
                    <td><a href="add_edit_services.php?idEdt=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">EDIT</a>
                    <a onclick="return confirm ('Yakin ingin menghapus?')" href="services.php?idDel=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">DELETE</a></td>
                  </tr>
                  <?php
                  } ?>
