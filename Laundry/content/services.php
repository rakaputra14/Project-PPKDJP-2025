        ...
        <div class="card">
            ...
            <div class="card-body">
                <div align="right" class="mb-3 mt-3">
                    <a href="?page=add-services" class="btn btn-primary">Create New Service</a>
                </div>
                    ...
                    <tbody>
                        ...
                        foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=add-services&edit=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="?page=services&delete=<?php echo $row['id'] ?>"
